...
afpops = ['variants/AF_%s' % pop for pop in pops]
'''
ds = hl.import_vcf('gnomad.exomes.r2.1.1.sites.22.vcf.bgz')
print(ds.count_rows())
print(ds.col()[:20])
'''
callset = allel.read_vcf('gnomad.exomes.r2.1.1.sites.22.vcf', fields=['PASS', 'ID', 'REF', 'ALT', 'variants/vep', 'variants/AF']+afpops)#, 'variants/variant_type', 'variants/allele_type', 'variants/AC', 'variants/AF'])
#df_allel = pd.DataFrame(callset)
n_genes = len(callset['variants/ID'])
print(callset['variants/ID'][:10])
print(callset['variants/REF'][:10])
print(callset['variants/ALT'][:10])
print(callset['variants/FILTER_PASS'][:10])
print(callset['variants/AF'][:10])
print(callset['variants/AF_asj'][:10])
print(callset['variants/vep'][:10])
...
syn_noncode = ['3_prime_UTR_variant', 'intron_variant', '5_prime_UTR_variant', 'downstream_gene_variant']
